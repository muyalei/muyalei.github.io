...
**参考：** [https://www.cnblogs.com/dajianshi/p/9455980.html](https://www.cnblogs.com/dajianshi/p/9455980.html)
...
ip地址  ：192.168.74.3 | 192.168.74.4 | 192.168.74.5
...
export CLASSPATH=.:$CLASSPATH:$JAVA_HOME/lib:$JRE_HOME/lib #这个不添加也可以，直接在主机hadoop时要设置的变量
export PATH=$PATH:$JAVA_HOME/bin:$JRE_HOME/bin #这个不添加也可以，同上
